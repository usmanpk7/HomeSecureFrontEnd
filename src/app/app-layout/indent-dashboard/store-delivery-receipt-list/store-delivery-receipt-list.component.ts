...
// @Component({
//   selector: 'app-store-delivery-receipt-list',
//   templateUrl: './store-delivery-receipt-list.component.html',
//   styleUrls: ['./store-delivery-receipt-list.component.css']
// })
// export class StoreDeliveryReceiptListComponent extends AppComponentBase implements OnInit {
...
//   @ViewChild('createStoreDelivery', { static: true }) createStoreDelivery: AddDeliveryReceiptComponent;
...
//   addReleaseDelivery(storereleasForm: any){
//     this.createStoreDelivery.openReleaseDelivery(storereleasForm.id)
//   }
