...
@Component({
  selector: 'app-incide-nts',
  templateUrl: './incide-nts.component.html',
  styleUrls: ['./incide-nts.component.css']
})
export class IncideNtsComponent implements OnInit {

  @ViewChild('map4') mapElement: any;
  ...
  ngAfterViewInit() {
    ...
    this.map = new google.maps.Map(document.getElementById("map4") as HTMLElement, {
      zoom: 8,
