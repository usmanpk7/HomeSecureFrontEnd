import { Component, Injector, OnInit, Input, AfterViewInit, ViewChild } from '@angular/core';
...
export class HeaderUserMenuComponent extends ThemesLayoutBaseComponent implements OnInit, AfterViewInit {
    ...
    showLoginAttempts(): void {
        this._router.navigate(['/home/login/attempts']);
    }
