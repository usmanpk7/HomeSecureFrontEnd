...
// import { ItemTypeDto, ItemTypeServiceProxy, ProfileServiceProxy } from '@shared/service-proxies/service-proxies';
// import { Table } from 'primeng/table';

// @Component({
//     selector: 'app-store-types-list',
//     templateUrl: './store-types-list.component.html',
//     styleUrls: ['./store-types-list.component.css'],
// })
// export class StoreTypesListComponent extends AppComponentBase implements OnInit {
