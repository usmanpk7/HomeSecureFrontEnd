...
//   styleUrls: ['./access-rejected.component.css']
// })
// export class AccessRejectedComponent extends AppComponentBase implements OnInit {
...
//       });
//       this.activityList = element.recentActivityList.filter(e => e.approvalStatus === false)
//        });
