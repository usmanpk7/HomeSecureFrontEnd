...
export class CreateDynamicEntityPropertyModalComponent extends AppComponentBase {
    ...
    private initialize() {
        ...
        let definedParametersObservable = this._dynamicEntityPropertyService.getAllPropertiesOfAnEntity(this.entityFullName, this.dynamicEntityProperty.dynamicPropertyName);
