...
export class AppNavigationService {
    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem('ThirdPartyLibraries', '', 'flaticon-interface-7', '',[], [
                new AppMenuItem('Manufacturers', '', 'flaticon-users', '/app/main/third-party-libraries/manufacturers'),
                new AppMenuItem('Suppliers', '', 'flaticon-users', '/app/main/third-party-libraries/suppliers'),
            ]),
