...
export class UserNotificationHelper extends AppComponentBase {
    ...
    CheckEntityNotification(usernotification:any){
        if(usernotification.notification.notificationName=="SentApprovalRequest")
             usernotification.notification.data.type="MyCompanyName.AbpZeroTemplate.ApprovalBindings.Dto.FormApprovalRequestNotificationData";
